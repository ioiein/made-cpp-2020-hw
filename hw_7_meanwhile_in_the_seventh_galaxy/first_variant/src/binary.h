#ifndef MEANWHILE_IN_THE_SEVENTH_GALAXY_FIRST_VARIANT_BINARY_H
#define MEANWHILE_IN_THE_SEVENTH_GALAXY_FIRST_VARIANT_BINARY_H
...
#endif /// MEANWHILE_IN_THE_SEVENTH_GALAXY_FIRST_VARIANT_BINARY_H.
